/* =========================================================
   ...
   Source: gcm-shell.js 2.0.57 production navigation
   Sprint: Morning Command — Universal Email Intake No-Action Routing
   Change:
   - Loads Universal Email Intake v2.4.0 with live Gmail ↔ D1 reconciliation on refresh.
...
(() => {
  ...
  function loadPageEnhancements() {
    ...
    if (/\/today\.html$/i.test(path)) {
      appendScript(
        "shared/today-email-intake.js?v=2.4.0",
