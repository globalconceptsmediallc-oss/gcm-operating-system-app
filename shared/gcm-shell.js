/* =========================================================
   ...
   Source: gcm-shell.js 2.0.61 production navigation
   Sprint: Morning Command — Universal Email Intake No-Action Routing
   Change:
   - Loads Universal Email Intake v2.6.0 with exact post-save Gmail cleanup and reporting-period fallback.
   ...
   - Loads Universal Email Intake v2.0.4 with Semrush weekly reporting-period prefill.
   - Loads Universal Email Intake v2.0.3 with full client-directory selection for historical signal review.
   - Loads Universal Email Intake v2.0.2 with month-only historical reporting-period prefill.
   - Loads Universal Email Intake v2.0.1 with client and reporting-period metadata prefill.
   - Loads Universal Email Intake v2.0.0 with compact title-only triage and human-reviewed Finding capture.
   - Loads Universal Email Intake v1.6.1 with corrected requested_work D1 routing.
   - Loads Universal Email Intake v1.6.0 with direct Work Item routing.
   - Loads Universal Email Intake v1.5.0 with Investigation routing.
   - Loads Universal Email Intake v1.4.0 with Monitoring Proof/history routing.
   - Loads Universal Email Intake v1.3.0 with Information routing and client selection.
   - Loads Universal Email Intake v1.2.0 with two-step no-action confirmation.
...
(() => {
  ...
  function loadPageEnhancements() {
    ...
    if (/\/today\.html$/i.test(path)) {
      appendScript(
        "shared/today-email-intake.js?v=2.6.0",
