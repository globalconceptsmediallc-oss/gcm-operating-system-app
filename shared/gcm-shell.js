/* =========================================================
   ...
   Source: gcm-shell.js 2.0.18 production navigation
   Sprint: Work Investigation Resolution States
   Change: Preserves the operational Work navigation and loads the hardened
           Investigation completion + monitoring state control on Work.
   ========================================================= */

(() => {
  "use strict";

  const SHELL_VERSION = "2.0.19";
  ...
  function loadPageEnhancements() {
    ...
    if(/\/work\.html$/i.test(path)) {
      appendScript("shared/work-investigation-completion.js?v=1.1.0","data-gcm-work-investigation-completion");
    }
