/* =========================================================
   ...
   Change notes — 1.3.12:
   - Updates the shared Monitoring evidence parser version lock from 1.1.6 to 1.1.7.
   - Preserves the existing Ahrefs metric assertions that guard against cross-metric
     corruption while the GSC value-before-label achievement fix remains active.
...
assert.equal(GMAIL_MONITORING_EVIDENCE_VERSION, "1.1.7");
