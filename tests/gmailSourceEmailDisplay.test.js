...
assert(source.includes("Version: 2.2.0"), "Today Gmail source display must identify version 2.2.0.");
...
assert(source.includes("const source = cleanSourceEmail(rawSource)"), "Morning Command must render the cleaned Source Email text.");
