/* =========================================================
   ...
   - Keeps the same D1-authoritative processed-message safety boundary.
   ...
   - Preserves Findings as a separate intelligence source from Proof, Work, Communications, and raw monitoring.
   ...
   - Active flights now surface extend-or-replace decisions before run end even when current traffic is confirmed.
   - Preserves the 3-business-day station deadline and saved placement dispositions.

   Changes in 7.27.3:
   - Aligns direct Work Item Communication metadata with the existing OS contract:
     operational_decision=work_required and status=work_item_open.
   - Keeps Universal Intake disposition=requested_work.
   ...
   - Preserves downstream duplicate recovery for the interrupted first attempt.

   Changes in 7.27.0:
   - Adds direct Work Item routing to Universal Email Intake human disposition.
   - Work routing writes one Communication and one Work Item, with no Investigation.
   - Preserves source email evidence in D1.

   Changes in 7.26.0:
   - Adds Investigation routing to Universal Email Intake human disposition.
   - Investigation writes one Communication and one Investigation, with no Work Item.
   - Preserves source email evidence in D1.

   Changes in 7.25.0:
   - Adds Monitoring routing to Universal Email Intake human disposition.
   - Monitoring writes exactly one Proof/history activity record and no Communication, Investigation, or Work Item.
   - Preserves source email evidence in D1.

   Changes in 7.24.0:
   - Adds Information routing to Universal Email Intake human disposition.
   - Information creates one Communication/history record and no Investigation or Work Item.
   - Requires explicit client selection and keeps source evidence in D1.

   Changes in 7.23.0:
   - Requires explicit confirmation for Universal Email Intake no-action writes.
   - Exposes Email Intake Disposition 1.1.0.
   - Prevents unconfirmed requests from reaching D1.
